      ...
      <div className="w-[85%] flex flex-wrap mx-auto border-b py-16 md-lg:pb-10 sm:pb-6">
        <div className="w-3/12 lg:w-4/12 sm:w-full">
          <div className="flex flex-col gap-3">
            <img className="w-[150px] h-[50x]" src={logo} alt="logo" />
            <ul className="flex flex-col gap-2 text-slate-600">
              <li>Address : Ibadan, Oyo</li>
              <li>Phone : +234estore</li>
              <li>Email : inf@estore.com</li>
            </ul>
          </div>
        </div>
        ...
        <div className="w-4/12 lg:w-full lg:mt-6">
          <div className="w-full flex flex-col justify-start gap-5">
            <h2 className="font-bold text-lg mb-2">Join Our News Letter</h2>
            <span>
            ...
            <div className="h-[50px] w-full bg-white border relative">
              <input
                ...
                type="text"
              />
              <button className="h-full absolute right-0  text-white uppercase px-4 font-bold text-sm"
              style={{
            ...
            <ul className="flex justify-start items-center gap-3">
              ...
              <li>
                <a
                  className="w-[38px] h-[38px] bg-white hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full"
                  href="#"
                >
                  <AiOutlineTwitter />
                </a>
